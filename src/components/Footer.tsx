                ...
                <div>
                    ...
                    <div className="mt-5 flex items-center justify-center gap-5 md:justify-start ">
                        <Link href="https://wa.me/251955800626" target="_blank" aria-label="WhatsApp" className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-gray-700 text-gray-300 transition hover:border-primary/40 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 ">
                            <Image src={whatsapp} alt="WhatsApp icon" title="WhatsApp" className="hover:scale-105 transition duration-400" />
                        </Link>
                        ...
                        <Link href="mailto:walintech22@gmail.com" aria-label="Email" target="_blank" className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-gray-700 text-gray-300 transition hover:border-primary/40 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/60">
